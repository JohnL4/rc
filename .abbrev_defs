...
(define-abbrev-table 'lisp-mode-abbrev-table
  '(
    ("ind" "indent-according-to-mode" nil 5)
    ("ins" "insert" nil 8)
   ))
...
(define-abbrev-table 'vbnet-mode-abbrev-table
  '(
    ("add" "Add" nil 0)
    ...
    ("notinheritable" "NotInheritable" nil 0)
    ("now" "Now" nil 0)
    ("nper" "NPer" nil 0)
    ("npv" "NPV" nil 0)
    ("object" "Object" nil 0)
